    ...
    processAudioData(buffer) {
        ...
        if (this.wasmReady) {
            ...
            this.magnitudes = new Float32Array(
                this.wasmModule.HEAPF32.buffer, magPtr, this.binCount
            );
            this.peakHold = new Float32Array(
                this.wasmModule.HEAPF32.buffer, peakPtr, this.binCount
            );
            this.timeDomain = new Float32Array(
                this.wasmModule.HEAPF32.buffer, timePtr, this.fftSize
            );
    ...
    getDataAtPosition(x, y) {
        if (this.magnitudes) {
            return this.visualizer.getDataAtPosition(
                x, y, this.magnitudes, this.binCount, this.sampleRate
            );
        }
        return null;
    }
